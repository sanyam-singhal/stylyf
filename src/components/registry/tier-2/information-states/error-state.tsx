...
export function ErrorState(userProps: ErrorStateProps) {
  ...
  return (
    <section class={cn("ui-card border-destructive/18 bg-destructive/6 px-[var(--space-6)] py-[var(--space-6)]", local.class)} {...others}>
      <div class="flex flex-col gap-4 sm:flex-row sm:items-start">
        <div class="inline-flex size-12 shrink-0 items-center justify-center rounded-full bg-destructive text-destructive-foreground shadow-soft">
