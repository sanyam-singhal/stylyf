...
export function ActivityFeed(userProps: ActivityFeedProps) {
  ...
  return (
    <section class={cn("ui-card space-y-[var(--space-4)] p-[var(--space-5)]", local.class)} {...others}>
        ...
        <For each={local.items}>
          {item => (
            <div class="relative flex gap-3 pl-1">
              <div class="absolute left-[1.35rem] top-10 h-[calc(100%-0.25rem)] w-px bg-border/70 last:hidden" />
