...
const clusterVisuals: Record<string, ClusterVisual> = {
  ...
  "tier-2-commercial-content": { color: "var(--warning)", contrast: "var(--warning-foreground)", icon: Sparkles },
  "tier-3-authentication": { color: "var(--destructive)", contrast: "var(--destructive-foreground)", icon: ShieldCheck },
  "tier-3-app-shells-dashboards": { color: "var(--primary)", contrast: "var(--primary-foreground)", icon: LayoutDashboard },
  "tier-3-settings-admin": { color: "var(--secondary-foreground)", contrast: "var(--secondary)", icon: Settings2 },
  "tier-3-workflows-onboarding": { color: "var(--success)", contrast: "var(--success-foreground)", icon: Milestone },
  "tier-3-marketing-navigation-hero": { color: "var(--warning)", contrast: "var(--warning-foreground)", icon: Navigation },
  "tier-3-footer-conversion": { color: "var(--accent-strong)", contrast: "var(--primary-foreground)", icon: ShoppingBag },
  "tier-3-docs-editorial": { color: "var(--info)", contrast: "var(--info-foreground)", icon: BookOpenText },
  "tier-3-trust-company": { color: "var(--success)", contrast: "var(--success-foreground)", icon: BriefcaseBusiness },
};
