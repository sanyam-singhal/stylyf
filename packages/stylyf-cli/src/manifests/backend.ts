...
export const backendCapabilityCatalog: Array<BackendCatalogEntry> = [
  ...
  },
  {
    ...
    keywords: ["resource", "relation", "crud", "entity", "table", "recipe", "v1.0"],
    snippet:
  ...
  },
  {
    ...
    keywords: ["ownership", "policy", "access", "owner", "workspace", "public", "rls", "v1.0"],
    snippet:
  ...
  },
  {
    ...
    keywords: ["attachment", "asset", "upload", "metadata", "storage", "s3", "tigris", "v1.0"],
    snippet:
  ...
  },
  {
    ...
    keywords: ["form", "mutation", "action", "validation", "resource", "solidstart", "v1.0"],
    snippet:
  ...
  },
  {
    ...
    keywords: ["workflow", "state", "transition", "event", "notification", "approval", "publish", "v1.0"],
    snippet:
...
export const backendSnippetCatalog: Array<BackendCatalogEntry> = [
  {
    ...
    description: "Create, validate, inspect, and generate from a small v1.0 spec.",
    summary: "The preferred v1.0 operator loop: author the intent-level spec, inspect the plan, then generate ordinary SolidStart source.",
    keywords: ["v1.0", "spec", "workflow", "new", "validate", "plan", "generate", "compiler"],
    snippet:
  ...
  },
  {
    ...
    label: "Canonical Portable v1.0 Example",
    kind: "backend-snippet",
    area: "Operator Workflow",
    description: "The clearest example set for the Better Auth + Drizzle + Tigris path.",
    summary: "Points operators toward the v1.0 portable examples and SQLite smoke path.",
    keywords: ["portable", "example", "canonical", "better-auth", "drizzle", "sqlite", "tigris"],
    snippet:
      `packages/stylyf-cli/examples/v1.0/internal-tool.basic.json\npackages/stylyf-cli/examples/v1.0/cms-site.basic.json\npackages/stylyf-cli/examples/v1.0/free-saas-tool.basic.json`,
    props: ["portable", "local", "sqlite"],
    sourcePath: "examples/README.md",
  },
  {
    id: "snippet-canonical-hosted-example",
    label: "Canonical Hosted v1.0 Example",
    kind: "backend-snippet",
    area: "Operator Workflow",
  ...
  },
  {
    ...
    keywords: ["resource", "ownership", "attachment", "relation", "workflow", "v1.0"],
    snippet:
  ...
  },
  {
    ...
    keywords: ["resource", "create", "edit", "form", "route", "page shell", "v1.0"],
    snippet:
      `"surfaces": [\n  { "name": "New Record", "kind": "create", "object": "records", "path": "/records/new" },\n  { "name": "Edit Record", "kind": "edit", "object": "records", "path": "/records/:id/edit" }\n]`,
  ...
  },
  {
    ...
    keywords: ["attachment", "asset", "upload", "presign", "confirm", "replace", "delete", "v1.0"],
    snippet:
  ...
  },
  {
    ...
    keywords: ["workflow", "event", "notification", "transition", "status", "audit", "v1.0"],
    snippet:
