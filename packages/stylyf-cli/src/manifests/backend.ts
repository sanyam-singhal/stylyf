...
export const backendCapabilityCatalog: Array<BackendCatalogEntry> = [
  ...
  },
  {
    ...
    kind: "capability",
    area: "Backend Capabilities",
    description: "SQLite capability using Drizzle ORM with the libsql driver for local files and later Turso-compatible upgrades.",
    summary: "Adds typed database wiring, Drizzle config, schema modules, and migration scripts for local auth+DB development.",
